...
int main(int argc, char *argv[])
{
    ...
    char *global_cfg_name= "/opt/iotloragateway/packet_forwarder/global_conf_sg0.json"; /* contain global (typ. network-wide) configuration */
    char *local_cfg_name = "/opt/iotloragateway/packet_forwarder/local_conf_sg0.json"; /* contain node specific configuration, overwrite global parameters for parameters that are defined in both */
    char *debug_cfg_name = "/opt/iotloragateway/packet_forwarder/debug_conf.json"; /* if present, all other configuration files are ignored */
